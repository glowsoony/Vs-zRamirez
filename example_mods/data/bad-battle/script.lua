...
function onStepHit()
    ...
    if curStep == 640 then
        ...
        doTweenX('cam2','camNotes', 0, 1, 'linear')
        doTweenX('cam3','camStrums', 0, 1, 'linear')
        doTweenX('cam4','camSustains', 0, 1, 'linear')
        doTweenX('cam5','camSplash', 0, 1, 'linear')
...
function onBeatHit()
    if move == true then
        if curBeat % 2 == 0 then
            ...
            doTweenX('cam2','camNotes', 250, 1.5, 'linear')
            doTweenX('cam3','camStrums', 250, 1.5, 'linear')
            doTweenX('cam4','camSustains', 250, 1.5, 'linear')
            doTweenX('cam5','camSplash', 250, 1.5, 'linear')
